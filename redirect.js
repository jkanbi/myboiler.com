...
<<<<<<< HEAD
    const STATIC_FOLDERS = ['css', 'js', 'img', 'pages', 'chat', 'quote', 'decide', 'heat-pump-checker', 'hub', 'calculators'];
=======
    const STATIC_FOLDERS = ['css', 'js', 'img', 'pages', 'chat', 'quote', 'decide', 'heat-pump-checker', 'hub'];
>>>>>>> 3465644 (Add static hub preparation page at /hub/)
